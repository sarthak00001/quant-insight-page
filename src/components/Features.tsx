  ...
  const features = [
    {
      ...
      description: "15+ years of successful trading experience",
      stat: "₹50Cr+",
    ...
    },
    {
      ...
      description: "Join 10,000+ active trading community",
      stat: "10k+",
      statLabel: "Students",
    },
    {
      ...
      description: "Step-by-step practical training modules",
      stat: "20+",
    ...
    },
    {
      icon: Headphones,
      title: "Live Support",
      description: "Get real-time help during market hours",
      stat: "24/7",
      statLabel: "Available",
    },
  ];
