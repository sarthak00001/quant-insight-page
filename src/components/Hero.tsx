          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                Masterclass on{" "}
                <span className="text-primary">Smart Money Trading</span>{" "}
                with Mahesh
              </h1>

              <p className="text-xl text-white/80 mb-4">
                Over <span className="font-bold text-primary">10,000+ traders</span> have already discovered the truth behind Smart Money movement and institutional psychology.
              </p>
            </div>
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">
                    <span className="font-bold">18k+</span> reviews (4.9/5)
                  </span>
                </div>
              </div>
            </div>
